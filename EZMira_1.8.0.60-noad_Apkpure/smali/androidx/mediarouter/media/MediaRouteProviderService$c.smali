...
.field c:Landroidx/mediarouter/media/s;

.field d:Landroidx/mediarouter/media/s;
...
.method private t(Landroid/os/Messenger;)Landroidx/mediarouter/media/MediaRouteProviderService$c$b;
    .locals 1

    .line 1
    invoke-virtual {p0, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$c;->s(Landroid/os/Messenger;)I
...
.method public a(Landroid/os/Messenger;IILjava/lang/String;)Z
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$c;->t(Landroid/os/Messenger;)Landroidx/mediarouter/media/MediaRouteProviderService$c$b;
    ...
    .line 2
    invoke-virtual {v0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$c$b;->e(I)Landroidx/mediarouter/media/MediaRouteProvider$e;
...
.method public d(Landroid/os/Messenger;IILjava/lang/String;Ljava/lang/String;)Z
    .locals 2
...
.method public e(Landroid/os/Messenger;IILandroid/content/Intent;)Z
    .locals 10
    ...
    .line 2
    invoke-virtual {v7, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$c$b;->e(I)Landroidx/mediarouter/media/MediaRouteProvider$e;
    ...
    .line 4
    :cond_0
    invoke-virtual {v8, p4, v0}, Landroidx/mediarouter/media/MediaRouteProvider$e;->d(Landroid/content/Intent;Landroidx/mediarouter/media/w$d;)Z
...
.method public f(Landroid/os/Messenger;III)Z
    ...
    .line 3
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/MediaRouteProvider$e;->i(I)V
...
.method public h()Landroidx/mediarouter/media/MediaRouteProvider$a;
    .locals 1
...
.method public i(Landroid/os/Messenger;IILjava/lang/String;)Z
    .locals 3
...
.method public j(Landroid/os/Messenger;IILjava/lang/String;)Z
    ...
    .line 2
    invoke-virtual {p0, p1, p3, p4}, Landroidx/mediarouter/media/MediaRouteProviderService$c;->r(Landroid/os/Messenger;ILjava/lang/String;)Landroidx/mediarouter/media/MediaRouteProviderService$c$b;
    ...
    invoke-virtual {p3}, Landroidx/mediarouter/media/MediaRouteProvider;->o()Landroidx/mediarouter/media/t;
    ...
    .line 10
    invoke-static {p3, p4}, Landroidx/mediarouter/media/MediaRouteProviderService;->a(Landroidx/mediarouter/media/t;I)Landroid/os/Bundle;
...
.method public k(Landroid/os/Messenger;IILjava/util/List;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public m(Landroid/os/Messenger;ILandroidx/mediarouter/media/s;)Z
    .locals 3
    ...
    .line 2
    invoke-virtual {v0, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$c$b;->j(Landroidx/mediarouter/media/s;)Z
    ...
    iget-object p3, p0, Landroidx/mediarouter/media/MediaRouteProviderService$c;->c:Landroidx/mediarouter/media/s;
...
.method public n(Landroid/os/Messenger;III)Z
    .locals 2
    ...
    .line 3
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/MediaRouteProvider$e;->g(I)V
...
.method public o(Landroid/os/Messenger;III)Z
    .locals 2
    ...
    .line 3
    invoke-virtual {v1, p4}, Landroidx/mediarouter/media/MediaRouteProvider$e;->j(I)V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p1, Landroidx/mediarouter/media/MediaRouteProviderService;->c:Landroid/os/Messenger;
...
.method public p(Landroid/os/Messenger;II)Z
    .locals 2
...
.method s(Landroid/os/Messenger;)I
    .locals 3
...
.method v(Landroidx/mediarouter/media/t;)V
    ...
    .line 4
    invoke-virtual {v2, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$c$b;->a(Landroidx/mediarouter/media/t;)Landroid/os/Bundle;
...
.method w()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService$c;->d:Landroidx/mediarouter/media/s;
    ...
    .line 3
    new-instance v3, Landroidx/mediarouter/media/v$a;

    iget-object v4, p0, Landroidx/mediarouter/media/MediaRouteProviderService$c;->d:Landroidx/mediarouter/media/s;

    .line 4
    invoke-virtual {v4}, Landroidx/mediarouter/media/s;->d()Landroidx/mediarouter/media/v;

    move-result-object v4

    invoke-direct {v3, v4}, Landroidx/mediarouter/media/v$a;-><init>(Landroidx/mediarouter/media/v;)V
    ...
    iget-object v6, v6, Landroidx/mediarouter/media/MediaRouteProviderService$c$b;->d:Landroidx/mediarouter/media/s;

    if-eqz v6, :cond_3

    .line 7
    invoke-virtual {v6}, Landroidx/mediarouter/media/s;->d()Landroidx/mediarouter/media/v;

    move-result-object v7

    invoke-virtual {v7}, Landroidx/mediarouter/media/v;->f()Z

    move-result v7

    if-eqz v7, :cond_1

    invoke-virtual {v6}, Landroidx/mediarouter/media/s;->e()Z
    ...
    invoke-direct {v3, v6}, Landroidx/mediarouter/media/v$a;-><init>(Landroidx/mediarouter/media/v;)V
    ...
    invoke-virtual {v3, v6}, Landroidx/mediarouter/media/v$a;->c(Landroidx/mediarouter/media/v;)Landroidx/mediarouter/media/v$a;
    ...
    .line 11
    :cond_5
    new-instance v1, Landroidx/mediarouter/media/s;

    invoke-virtual {v3}, Landroidx/mediarouter/media/v$a;->d()Landroidx/mediarouter/media/v;

    move-result-object v3

    invoke-direct {v1, v3, v0}, Landroidx/mediarouter/media/s;-><init>(Landroidx/mediarouter/media/v;Z)V

    .line 12
    :goto_3
    iget-object v0, p0, Landroidx/mediarouter/media/MediaRouteProviderService$c;->c:Landroidx/mediarouter/media/s;

    invoke-static {v0, v1}, Lb/h/p/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 13
    iput-object v1, p0, Landroidx/mediarouter/media/MediaRouteProviderService$c;->c:Landroidx/mediarouter/media/s;
    ...
    invoke-virtual {v0, v1}, Landroidx/mediarouter/media/MediaRouteProvider;->y(Landroidx/mediarouter/media/s;)V
