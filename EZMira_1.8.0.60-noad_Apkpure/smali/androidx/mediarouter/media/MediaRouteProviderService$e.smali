...
.method private a(ILandroid/os/Messenger;IILjava/lang/Object;Landroid/os/Bundle;Ljava/lang/String;)Z
    ...
    invoke-interface {p5, p2, p3, p4, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->k(Landroid/os/Messenger;IILjava/util/List;)Z
    ...
    invoke-interface {p5, p2, p3, p4, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->a(Landroid/os/Messenger;IILjava/lang/String;)Z
    ...
    invoke-interface {p5, p2, p3, p4, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->i(Landroid/os/Messenger;IILjava/lang/String;)Z
    ...
    .line 12
    invoke-static {p5}, Landroidx/mediarouter/media/s;->c(Landroid/os/Bundle;)Landroidx/mediarouter/media/s;
    ...
    .line 14
    invoke-virtual {p1}, Landroidx/mediarouter/media/s;->f()Z
    ...
    .line 15
    :goto_0
    invoke-interface {p4, p2, p3, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->m(Landroid/os/Messenger;ILandroidx/mediarouter/media/s;)Z
    ...
    invoke-interface {p1, p2, p3, p4, p5}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->e(Landroid/os/Messenger;IILandroid/content/Intent;)Z
    ...
    invoke-interface {p5, p2, p3, p4, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->o(Landroid/os/Messenger;III)Z
    ...
    invoke-interface {p5, p2, p3, p4, p1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->n(Landroid/os/Messenger;III)Z
    ...
    invoke-interface {p1, p2, p3, p4, v1}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->f(Landroid/os/Messenger;III)Z
    ...
    invoke-interface {p1, p2, p3, p4}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->p(Landroid/os/Messenger;II)Z
    ...
    invoke-interface/range {v2 .. v7}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->d(Landroid/os/Messenger;IILjava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {p1, p2, p3}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->q(Landroid/os/Messenger;I)Z
    ...
    invoke-interface {p1, p2, p3, p4, p7}, Landroidx/mediarouter/media/MediaRouteProviderService$a;->j(Landroid/os/Messenger;IILjava/lang/String;)Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 2
    invoke-static {v8}, Landroidx/mediarouter/media/u;->a(Landroid/os/Messenger;)Z
