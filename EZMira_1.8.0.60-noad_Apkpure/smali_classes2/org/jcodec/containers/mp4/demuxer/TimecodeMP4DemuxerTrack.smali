...
.method public constructor <init>(Lorg/jcodec/containers/mp4/boxes/MovieBox;Lorg/jcodec/containers/mp4/boxes/TrakBox;Lorg/jcodec/common/SeekableByteChannel;)V
    ...
    const-string p3, "stts"

    filled-new-array {p3}, [Ljava/lang/String;

    move-result-object p3

    invoke-static {p1, p2, p3}, Lorg/jcodec/containers/mp4/boxes/Box;->findFirst(Lorg/jcodec/containers/mp4/boxes/NodeBox;Ljava/lang/Class;[Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 7
    const-class p3, Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox;
    ...
    invoke-static {p1, p3, v0}, Lorg/jcodec/containers/mp4/boxes/Box;->findFirst(Lorg/jcodec/containers/mp4/boxes/NodeBox;Ljava/lang/Class;[Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox;
    ...
    invoke-static {p1, v1, v2}, Lorg/jcodec/containers/mp4/boxes/Box;->findFirst(Lorg/jcodec/containers/mp4/boxes/NodeBox;Ljava/lang/Class;[Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 12
    invoke-virtual {p3}, Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox;->getSampleToChunk()[Lorg/jcodec/containers/mp4/boxes/SampleToChunkBox$SampleToChunkEntry;
...
.method private getTimecodeSample(I)I
    ...
    invoke-interface {p1, v3, v4}, Lorg/jcodec/common/SeekableByteChannel;->position(J)Lorg/jcodec/common/SeekableByteChannel;
...
.method public getTimecode(Lorg/jcodec/containers/mp4/MP4Packet;)Lorg/jcodec/containers/mp4/MP4Packet;
    ...
    invoke-virtual {p1}, Lorg/jcodec/common/model/Packet;->getTimescale()J

    move-result-wide v3

    invoke-virtual {v0, v1, v2, v3, v4}, Lorg/jcodec/containers/mp4/boxes/TrakBox;->rescale(JJ)J
    ...
    invoke-direct {p0, v2, v1, v3}, Lorg/jcodec/containers/mp4/demuxer/TimecodeMP4DemuxerTrack;->getTimecode(IILorg/jcodec/containers/mp4/boxes/TimecodeSampleEntry;)Lorg/jcodec/common/model/TapeTimecode;

    move-result-object v1

    invoke-direct {v0, p1, v1}, Lorg/jcodec/containers/mp4/MP4Packet;-><init>(Lorg/jcodec/containers/mp4/MP4Packet;Lorg/jcodec/common/model/TapeTimecode;)V
